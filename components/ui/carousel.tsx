...
function CarouselContent({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ref={carouselRef}
      className="overflow-hidden -mr-4 md:mr-0"
      data-slot="carousel-content"
    >
      <div
        className={cn("flex -ml-5", className)}
        {...props}
      />
    </div>
  )
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "size-9 touch-manipulation rounded-lg disabled:opacity-50",
        className
      )}
      ...
      {...props}
    >
      <ChevronDown className="cn-rtl-flip size-5 rotate-90 stroke-primary stroke-[1.25px]" />
