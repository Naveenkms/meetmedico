...
export default function SearchTherapistssForm() {
  ...
  return (
    ...
    >
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            <SearchProfessionalsFormSpecialityInput
              label="Specialty"
              placeholder="eg. Counseling, Therapy"
              aria-invalid={fieldState.invalid}
              {...field}
            />
            {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
      ...
      />
      <Field>
        <SearchProfessionalsFormSubmitButton form="search-therapists">
          Search Therapists
        </SearchProfessionalsFormSubmitButton>
      </Field>
    </SearchProfessionalsForm>
